...
describe("Merge Objetos", () => {
    test("Deve fazer o merge dos dois objetos passados como paramentros, caso a o 3 paramentro seja true.", () => {
        expect(mergeObj({nome:'Joaquim', sobrenome: "Firmo"}, {sexo: 'M', idade: 25}, true)).toEqual(
            {nome:'Joaquim', sobrenome: "Firmo", sexo: 'M', idade: 25});         
    });

    test("Não deve fazer o merge dos dois objetos passados como paramentros, caso a o 3 paramentro seja true.", () => {
